...
import MCReactModule from "@orustecnologia/react-native-marketingcloudsdk";
  ...
  render() {
    return (
      <View style={styles.verticalContainer}>
        ...
        />
        <View
          style={[styles.horizontalContainer, { justifyContent: "flex-end" }]}
        >
          <Button title={"Set Contact Key"} onPress={this.setContactKey} />
        </View>
        ...
        <View
          style={[styles.horizontalContainer, { justifyContent: "flex-end" }]}
        >
          <Button title={"Clear Attribute"} onPress={this.clearAttribute} />
          <View style={{ padding: 10 }} />
          <Button title={"Set Attribute"} onPress={this.setAttribute} />
        </View>
        <Text style={styles.body}>
          {JSON.stringify(this.state.attributes, undefined, 2)}
        </Text>
        ...
        <View
          style={[styles.horizontalContainer, { justifyContent: "flex-end" }]}
        >
          <Button title={"Remove Tag"} onPress={this.removeTag} />
          <View style={{ padding: 10 }} />
          <Button title={"Add Tag"} onPress={this.addTag} />
        </View>
        <Text style={styles.body}>
          {JSON.stringify(this.state.tags, undefined, 2)}
        </Text>
      </View>
    );
  }
  ...
  render() {
    return (
      <View style={styles.verticalContainer}>
        ...
        <Button
          disabled={this.state.toggleEnabled}
...
class LoggingComponent extends Component {
  constructor(props) {
    ...
    LoggingComponent.disableLogging =
      LoggingComponent.disableLogging.bind(this);
