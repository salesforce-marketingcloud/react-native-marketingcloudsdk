...
const { RNSFMCSdk, RNSFMCEventEmitter } = NativeModules;

const SFMCEventEmitter = new NativeEventEmitter(RNSFMCEventEmitter);
...
class MCReactModule {
   ...
   */
  static setOnNotificationOpenedListener(callback) {
    return SFMCEventEmitter.addListener('SFMCNotificationOpened', callback);
  }
}
